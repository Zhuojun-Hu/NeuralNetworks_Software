...
#SBATCH --output=/sps/t2k/mferey/CAVERNS/NeuralNetworks_Software/logs/WCTE_uni_iso_eVSmu_v2/WCTE_uni_iso_eVSmu_raw.log             # Standard output and error log
...
config_name=WCTE_uni_iso_raw_eVSmu_main.yaml
