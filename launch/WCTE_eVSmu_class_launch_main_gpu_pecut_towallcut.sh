...
#SBATCH --output=/sps/t2k/mferey/CAVERNS/NeuralNetworks_Software/logs/WCTE_uni_iso_eVSmu_v2/WCTE_uni_iso_eVSmu_pecut_towallcut_lr4e-4_bz5000_%j.log             # Standard output and error log
...
config_name=WCTE_uni_iso_pecut_towallcut_eVSmu_main.yaml
