...
#SBATCH --output=/sps/t2k/mferey/CAVERNS/NeuralNetworks_Software/logs/WCTE_uni_iso_eVSmu_v2/WCTE_uni_iso_eVSmu_pecut.log             # Standard output and error log
...
config_name=WCTE_uni_iso_pecut_eVSmu_main.yaml
